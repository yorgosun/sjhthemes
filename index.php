...
?>
				<img src="<?php echo get_the_post_thumbnail_url(null,array(160,100))?>" data-target="#myCarousel" data-slide-to="<?php echo $n?>" <?php if ($n==0) echo " class=\"active\"" ?>>
<?php
        		$n++;
                        endwhile;
                        wp_reset_postdata();
...
<?php
			...
			$n = 0;
                        ...
                        while ( $query1->have_posts() ) : $query1->the_post();
?>
				<div class="<?php if ($n==0) echo "active " ?>item" data-slide-number="<?php echo $n?>">
...
?>
		...
		<div class="container content-block">
			<div class="col-md-3">
				...
				<p class="peitu-desc">描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字</p>
			</div>
			<div class="col-md-3">
...
?>
                                                ...
                                                <a href="<?php echo get_the_permalink(); ?>"><img src="/wp-content/themes/twentysixteen/img/book.jpg"></a>
<?php
                        endwhile;
                        wp_reset_postdata();
?>
