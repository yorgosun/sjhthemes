...
///head c"<?php echo get_the_permalink();
    ?>
								...
								<a href="http://sutrachanting.longquanzs.org/index.php/nggallery/诵经活动-1/<?php echo get_the_title() ?>?page_id=2473"><button class="newbutton"  style="width: 32%;" type="button">照片</button></a>
								</p>
								</div>
								<?php
endwhile;
