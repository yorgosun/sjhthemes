...
<?php
file_get_contents("http://3387.liveplay.myqcloud.com/live/3387_211d0f473ccc11e6a2cba4dcbef5e35a.m3u8");
?>
...
///head c"<?php echo get_the_permalink();
    ?>
										...
										<a href="<?php echo get_post_meta(get_the_id(), '心得', true) ?>&<?php echo get_post_meta(get_the_id(), '心得图库标题', true) ?>"><button class="newbutton"  style="width: 32%;" type="button">心得</button></a>
										<a href="http://sutrachanting.longquanzs.org/index.php/nggallery/诵经活动-1/<?php echo get_the_title() ?>?page_id=2473&<?php echo get_post_meta(get_the_id(), '心得图库标题', true) ?>"><button class="newbutton"  style="width: 32%;" type="button">照片</button></a>
										</p>
										</div>
										<?php
endwhile;
