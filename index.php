...
///head c"<?php echo get_the_permalink();
    ?>
			<div class="col-md-6">
				...
				<p>
				<a href="<?php echo get_post_meta(get_the_id(), '周报', true) ?>"><button style="width: 33%;" type="button">周报</button></a>
				<a href="<?php echo get_post_meta(get_the_id(), '心得', true) ?><?php echo get_post_meta(get_the_id(), 'activitytime', true) ?>"><button style="width: 33%;" type="button">心得</button></a>
				<a href="<?php echo get_post_meta(get_the_id(), '照片', true) ?>"><button style="width: 33%;" type="button">照片</button></a>
				</p>
			</div>
				<?php
endwhile;
