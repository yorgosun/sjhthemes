...
///head c"<?php echo get_the_permalink();
    ?>
		<div class="col-md-6">
			...
			<p>地点：<?php echo get_post_meta(get_the_id(), 'activitylocation', true) ?></p>
			<p>
			<a href=""><button style="width: 33%;" type="button">周报</button></a>
			<a href=""><button style="width: 33%;" type="button">心得</button></a>
			<a href=""><button style="width: 33%;" type="button">照片</button></a>
			</p>
		</div>
	<?php
endwhile;
