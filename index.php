...
///head c"<?php echo get_the_permalink();
    ?>
			...
			<a href="http://yorgo.91yousheng.com/index.php/nggallery/诵经活动-1/<?php echo get_post_meta(get_the_id(), '照片', true) ?>?page_id=2473"><button class="newbutton"  style="width: 32%;" type="button">照片</button></a>
			</p>
			</div>
			<?php
endwhile;
