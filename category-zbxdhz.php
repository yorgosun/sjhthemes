...
//图片的尺寸要在common.css里调整，下面img暂时先写样式
    ...
    ?>
			...
			<a style="width:32%" href="<?php echo get_post_meta(get_the_id(), '心得', true) ?>"><button  class="newbutton" type="button">心得</button></a>
			<a style="width:32%" href="http://sutrachanting.longquanzs.org/index.php/nggallery/诵经活动-1/<?php echo get_the_title() ?>?page_id=2473"><button  class="newbutton" type="button">照片</button></a>
			</p>
			</li>
			<?php
endwhile;
